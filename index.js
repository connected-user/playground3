...
/***/ function(module, exports, __webpack_require__) {
	...
	var router = _react2.default.createElement(_reactRouter.Router, { routes: _routes2.default, history: _reactRouter.hashHistory });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Techniques = __webpack_require__(241);

	var _Techniques2 = _interopRequireDefault(_Techniques);

	var _Calculator = __webpack_require__(242);
	...
	exports.default = _react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: 'techniques', component: _Techniques2.default }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html {\n  box-sizing: border-box;\n  margin: 0;\n  padding: 0;\n}\n*,\n*:before,\n*:after {\n  box-sizing: inherit;\n}\nbody {\n  margin: 0;\n  padding: 0;\n  font-size: 10px;\n  font-family: 'Lato', 'Helvetica Neue', Helvetica, sans-serif;\n  background: #333;\n  color: #DDD;\n}\nul {\n  margin: 0;\n  padding: 0;\n}\nul li {\n  list-style: none;\n}\n@font-face {\n  font-family: 'icomoon';\n  src: url(" + __webpack_require__(228) + ");\n  src: url(" + __webpack_require__(228) + "#iefix) format('embedded-opentype'), url(" + __webpack_require__(229) + ") format('truetype'), url(" + __webpack_require__(230) + ") format('woff'), url(" + __webpack_require__(231) + "#icomoon) format('svg');\n  font-weight: normal;\n  font-style: normal;\n}\n[class^=\"icon-\"],\n[class*=\" icon-\"] {\n  /* use !important to prevent issues with browser extensions that change fonts */\n  font-family: 'icomoon' !important;\n  speak: none;\n  font-style: normal;\n  font-weight: normal;\n  font-variant: normal;\n  text-transform: none;\n  line-height: 1;\n  font-size: 1.5em;\n  /* Better Font Rendering =========== */\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n}\n.icon-search:before {\n  content: \"\\E900\";\n}\n.icon-bubble2:before {\n  content: \"\\E901\";\n}\n.icon-user:before {\n  content: \"\\E902\";\n}\n.icon-search2:before {\n  content: \"\\E903\";\n}\n#app {\n  font-size: 1.5em;\n}\n.ri-top-navigation {\n  position: fixed;\n  top: 0;\n  left: 0;\n  right: 0;\n  height: 50px;\n  background: #FFF;\n  background: linear-gradient(-180deg, #FFFFFF 0%, #EFEFEF 100%);\n  border-bottom: 1px solid #FFF;\n  z-index: 10;\n}\n.ri-content {\n  margin-top: 50px;\n}\n.ri-page {\n  padding: 40px;\n  margin: 0 auto;\n}\n@media only screen and (min-width: 992px) {\n  .ri-page {\n    width: 1024px;\n  }\n}\n.ri-page.ri-full-page {\n  width: auto;\n  margin: 0;\n}\n.ri-top-navigation > * {\n  display: inline-block;\n  vertical-align: top;\n}\n.ri-top-navigation ul {\n  margin: 17px 0 0 50px;\n  font-weight: bold;\n  text-transform: uppercase;\n  font-size: 12px;\n}\n.ri-top-navigation ul li {\n  display: inline-block;\n}\n.ri-top-navigation ul a,\n.ri-top-navigation ul a:visited {\n  color: #333;\n  text-decoration: none;\n  margin: 0 10px 0 0;\n  padding: 2px 8px;\n  border-radius: 20px;\n  border: 1px solid transparent;\n  font-weight: 700;\n}\n.ri-top-navigation ul a.active {\n  position: relative;\n  color: #FFCC00;\n  background: #333333;\n}\n.ri-top-navigation ul a.active:after {\n  position: absolute;\n  bottom: -6px;\n  left: 40%;\n  content: \"\";\n  width: 0;\n  height: 0;\n  border-left: 7px solid transparent;\n  border-right: 7px solid transparent;\n  border-top: 5px solid #333333;\n}\n@media only screen and (max-width: 768px) {\n  .ri-top-navigation ul {\n    display: none;\n  }\n  .ri-top-navigation ul li {\n    display: block;\n    padding: 5px;\n  }\n}\n.ri-top-navigation .ri-logo {\n  width: 64px;\n  height: 33px;\n  margin: 7px 0 0 25px;\n  background: url(" + __webpack_require__(232) + ") no-repeat;\n}\n@media (-webkit-min-device-pixel-ratio: 2), (min-resolution: 192dpi) {\n  .ri-top-navigation .ri-logo {\n    background: url(" + __webpack_require__(233) + ") no-repeat;\n    background-size: 100%;\n  }\n}\n.ri-top-navigation .ri-search-bar {\n  display: none;\n  margin: 10px 10px 0 0;\n  float: right;\n  position: relative;\n}\n.ri-top-navigation .ri-search-bar .icon-search {\n  color: #666;\n  position: absolute;\n  top: 7px;\n  left: 10px;\n  font-size: 17px;\n}\n.ri-top-navigation .ri-search-bar .search-input {\n  width: 130px;\n  padding: 5px 10px 5px 30px;\n  border: 1px solid #BBB;\n  background: none;\n  border-radius: 30px;\n  font-size: 15px;\n  transition: 250ms ease;\n}\n.ri-top-navigation .ri-search-bar .search-input:focus {\n  outline: none;\n  width: 180px;\n  border-color: #FFCC00;\n}\n.ri-photo-feed {\n  visibility: hidden;\n  margin: 0 auto;\n}\n.ri-photo-feed.is-visible {\n  visibility: visible;\n}\n.ri-photo-feed-item {\n  width: 300px;\n  display: inline-block;\n  border-radius: 5px;\n  margin-bottom: 30px;\n}\n.ri-photo-feed-item .photo-wrapper {\n  overflow: hidden;\n  border-radius: 5px;\n}\n.ri-photo-feed-item .photo-wrapper img {\n  width: 100%;\n}\n.ri-photo-feed-item .photo-details {\n  padding: 10px;\n  background: #FFF;\n  position: relative;\n  margin-top: 10px;\n  border-radius: 5px 5px 0 0;\n}\n.ri-photo-feed-item .photo-details:before {\n  content: \"\";\n  position: absolute;\n  right: 20px;\n  top: -7px;\n  width: 0;\n  height: 0;\n  border-left: 9px solid transparent;\n  border-right: 9px solid transparent;\n  border-bottom: 7px solid #FFF;\n}\n.ri-photo-feed-item .photo-details .photo-title {\n  color: #222;\n  font-size: 15px;\n  font-weight: 700;\n  margin-bottom: 10px;\n}\n.ri-photo-feed-item .photo-details .photo-title:hover {\n  text-decoration: underline;\n}\n.ri-photo-feed-item .photo-details .photo-description {\n  color: #858585;\n  font-size: 11px;\n}\n.ri-photo-feed-item .author-details {\n  position: relative;\n  padding: 10px;\n  background: #000;\n  border-radius: 0 0 5px 5px;\n}\n.ri-photo-feed-item .photo-score {\n  position: absolute;\n  bottom: 20px;\n  right: -20px;\n  border-radius: 40px;\n  width: 40px;\n  height: 40px;\n  border: 2px solid #000;\n  background: #91949D;\n}\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "91a7496a5e2b2ca75267db6fd6e35d04.eot";

/***/ },
/* 229 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "f9be2c3b394572049323d14657f3f98c.ttf";

/***/ },
/* 230 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "272e96a7210f65c035b3247d09d28b20.woff";

/***/ },
/* 231 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "593aee5d9d07332ee231ddc48cee3003.svg";

/***/ },
/* 232 */
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"

/***/ },
/* 233 */
/***/ function(module, exports) {

	module.exports = "data:image/png;base64,"
	...
	var SearchBar = function (_React$Component) {
	  ...
	  _createClass(SearchBar, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'ri-search-bar' },
	        _react2.default.createElement('span', { className: 'icon-search' }),
	        _react2.default.createElement('input', { className: 'search-input', type: 'text' })
	      );
	    }
	  }]);
	...
	var Navigation = function (_React$Component2) {
	  ...
	  _createClass(Navigation, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'ri-top-navigation' },
	        _react2.default.createElement(_reactRouter.Link, { to: '/', className: 'ri-logo' }),
	        _react2.default.createElement(
	          'ul',
	          null,
	          _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _reactRouter.Link,
	              { to: 'techniques', activeClassName: 'active' },
	              'Techniques'
	            )
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              _reactRouter.Link,
	              { to: 'calculator', activeClassName: 'active' },
	              'Savings Calculator'
	            )
	          )
	        ),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PhotoFeed = __webpack_require__(238);
	...
	var Photos = function (_React$Component) {
	  ...
	  _createClass(Photos, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'div',
	        { className: 'ri-page ri-full-page' },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MockPhotoFeedData = __webpack_require__(239);

	var _MockPhotoFeedData2 = _interopRequireDefault(_MockPhotoFeedData);
	...
	var FeedItem = function FeedItem(_ref) {
	  ...
	  return _react2.default.createElement(
	    'div',
	    { className: 'ri-photo-feed-item' },
	    _react2.default.createElement(
	      'div',
	      { className: 'photo-wrapper' },
	      _react2.default.createElement('img', { src: data.imgUrl })
	    ),
	    _react2.default.createElement(
	      'div',
	    ...
	    _react2.default.createElement('div', { className: 'photo-score' })
	  );
	};

	var PhotoFeed = function (_React$Component) {
	  _inherits(PhotoFeed, _React$Component);

	  function PhotoFeed(props) {
	    _classCallCheck(this, PhotoFeed);

	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(PhotoFeed).call(this, props));
	  ...
	  _createClass(PhotoFeed, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var feedClass = this.state.isVisible ? 'ri-photo-feed is-visible' : 'ri-photo-feed';
	      var feed = _MockPhotoFeedData2.default.concat(_MockPhotoFeedData2.default).concat(_MockPhotoFeedData2.default);
	      return _react2.default.createElement(
	        'div',
	        { className: feedClass },
	        feed.map(function (item, index) {
	          return _react2.default.createElement(FeedItem, { key: index, data: item });
	        })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Techniques = function (_React$Component) {
	  ...
	  function Techniques() {
	    ...
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Techniques).apply(this, arguments));
	  }
